...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === 'success') {
    icon = <HugeiconsIcon icon={CircleCheckIcon} aria-hidden="true" />
  }

  if (type === 'info') {
    icon = <HugeiconsIcon icon={InfoIcon} aria-hidden="true" />
  }

  if (type === 'warning') {
    icon = <HugeiconsIcon icon={TriangleAlertIcon} aria-hidden="true" />
  }
