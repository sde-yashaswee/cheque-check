        ...
        <div className="space-y-4 rounded-lg bg-white p-8 dark:bg-surface-tile-1 border border-primary/5">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <HugeiconsIcon icon={EyeOff} className="h-5 w-5" />
                  ) : (
                    <HugeiconsIcon icon={Eye} className="h-5 w-5" />
                  )}
                </button>
              </div>
            </div>
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-muted-foreground dark:bg-surface-tile-1">
                {tc('orContinueWith')}
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="h-12 rounded-sm font-normal"
