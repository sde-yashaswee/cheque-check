      ...
      <div className="space-y-6 px-2">
        <div className="rounded-lg border bg-card overflow-hidden">
          <div className="p-6 text-center space-y-2 bg-muted/20">
            ...
            <p className="text-sm text-muted-foreground">The most professional way to manage your business cheques.</p>
          </div>
          ...
          <div className="divide-y divide-border/50">
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Developer</span>
              </div>
              <span className="text-sm font-bold">ChequeCheck Team</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Version</span>
              </div>
